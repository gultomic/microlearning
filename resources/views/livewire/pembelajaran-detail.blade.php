<div class="py-12">
    <x-slot name="header">
        <div class="flex justify-between" x-data="{ modelOpen: false }">
                ...
                <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                    ...
                    >
                        ...
                        <div class="flex justify-end mt-6">
                            ...
                            <button for="show" @click="modelOpen = false" type="button" class="px-4 py-2 mr-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-500 rounded-md shadow-md hover:bg-red-600">
                                Hapus
                            </button>
                        </div>
                    </div>
